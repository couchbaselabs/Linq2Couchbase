...
namespace Couchbase.Linq.Tests.QueryGeneration
{
    ...
    public class MemberNameResolutionTests : N1QLTestBase
    {
        ...
        public void Test_Default_JsonProp_Att()
        {
            ...
            var query =
                QueryFactory.Queryable<Contact>(mockBucket.Object)
                    ...
                    .Select(e => new { age = e.Age, firstName = e.FirstName, lastName = e.LastName, children = e.Children });

            const string expected = "SELECT e.age as age, e.fname as firstName, e.lname as lastName, e.children as children FROM default as e WHERE ((e.age < 40) AND (e.fname LIKE '%a%'))";
        ...
        public void Test_Default_No_Att()
        {
            ...
            const string expected = "SELECT e.Name as brewName, e.City as brewCity FROM default as e WHERE (e.Country LIKE '%a%')";
