...
namespace Couchbase.Linq.UnitTests.QueryGeneration
{
    ...
    public class SingleTests : N1QLTestBase
    {
        ...
        public void Test_Single()
        {
            ...
            const string expected = "SELECT RAW `Extent1` FROM `default` as `Extent1` LIMIT 2";
        ...
        public void Test_SingleWithSkip()
        {
            ...
            const string expected = "SELECT RAW `Extent1` FROM `default` as `Extent1` LIMIT 2 OFFSET 10";
        ...
        public async Task Test_SingleAsyncWithPredicate()
        {
            ...
            const string expected = "SELECT RAW `Extent1` FROM `default` as `Extent1` WHERE (`Extent1`.`age` > 5) LIMIT 2";
