...
namespace Couchbase.Linq.UnitTests.QueryGeneration
{
    ...
    public class JoinTests : N1QLTestBase
    {
        ...
        [Test]
        public void Test_InnerJoin_Simple55()
        {
            var mockBucket = new Mock<IBucket>();
            mockBucket.SetupGet(e => e.Name).Returns("default");
        ...
        [Test]
        public void Test_InnerJoin_SortAndFilter55()
        {
            var mockBucket = new Mock<IBucket>();
            mockBucket.SetupGet(e => e.Name).Returns("default");
        ...
        [Test]
        public void Test_InnerJoin_Prefiltered55()
        {
            var mockBucket = new Mock<IBucket>();
            mockBucket.SetupGet(e => e.Name).Returns("default");
        ...
        [Test]
        public void Test_LeftJoin_Simple55()
        {
            var mockBucket = new Mock<IBucket>();
            mockBucket.SetupGet(e => e.Name).Returns("default");
        ...
        [Test]
        public void Test_LeftJoin_SortAndFilter55()
        {
            var mockBucket = new Mock<IBucket>();
            mockBucket.SetupGet(e => e.Name).Returns("default");
        ...
        [Test]
        public void Test_LeftJoin_Prefiltered55()
        {
            var mockBucket = new Mock<IBucket>();
            mockBucket.SetupGet(e => e.Name).Returns("default");
        ...
        [Test]
        public void Test_InnerJoin_IndexJoinVersion55()
        {
            var mockBucket = new Mock<IBucket>();
            mockBucket.SetupGet(e => e.Name).Returns("default");
        ...
        [Test]
        public void Test_LeftJoin_IndexJoinVersion55()
        {
            var mockBucket = new Mock<IBucket>();
            mockBucket.SetupGet(e => e.Name).Returns("default");
