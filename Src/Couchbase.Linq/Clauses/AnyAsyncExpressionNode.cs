...
namespace Couchbase.Linq.Clauses
{
    ...
    /// </summary>
    internal class AnyAsyncExpressionNode : ResultOperatorExpressionNodeBase
    {
        /// <summary>
        ...
        {
            QueryExtensionMethods.AnyAsyncNoPredicate,
            QueryExtensionMethods.AnyAsyncWithPredicate
        };

        /// <summary>
        /// Creates a new AnyAsyncExpressionNode.
        /// </summary>
